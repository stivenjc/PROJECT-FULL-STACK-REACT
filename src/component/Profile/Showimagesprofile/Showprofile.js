...
import { getMe, updateFotoUser } from "../../../api/usersAPI";
import { useDispatch } from "react-redux";
import { setDetail } from "../../../actions";

export default function Showprofile({ show, handleClose, image, miImfo }) {
  ...
  const formik = useFormik({
    ...
    onSubmit: async (formValue) => {
      try {
        await updateFotoUser(miImfo.id, formValue);
        handleClose();
        getUserImfo();
        setActualizar(false);
      } catch (error) {
